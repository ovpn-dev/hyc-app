...
const BlogScreen = () => {
  ...
  // Blog list view with back button
  return (
    <SafeAreaView className="flex-1">
      <View className="mb-2 p-2 bg-[#161622] flex-row items-center">
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text className="text-white text-lg mr-4">← Back</Text>
        </TouchableOpacity>
        <Text className="text-lg text-center text-blue-400 flex-1">
